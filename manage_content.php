...
<div class="container">
  ...
  <a class="btn btn-warning" href="create_menu.php" role="button">Create new menu</a>
  <a class="btn btn-warning" href="create_page.php" role="button">Create new page</a>
  <a class="btn btn-danger" href="edit_menu.php" role="button">Edit menu</a>
  <a class="btn btn-danger" href="#" role="button">Edit page</a>
  <a class="btn btn-danger" href="delete_menu.php" role="button">Delete menu</a>
  <a class="btn btn-danger" href="#" role="button">Delete page</a>
...
}elseif ($select_page_id) {
 
  $query1 = "SELECT * FROM `posts` WHERE id =".$select_page_id;
  $result1 = mysqli_query($conn ,$query1);
  if (mysqli_num_rows($result1) > 0) {
    while ($row1 = mysqli_fetch_assoc($result1)) {
       echo $row1['title'];
